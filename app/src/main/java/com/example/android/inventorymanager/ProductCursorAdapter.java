...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        productPrice.setText(context.getString(R.string.price_field) + " " + price);
        productQuantity.setText(quantity + " " + context.getString(R.string.quantity_field));
        ...
        saleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity > 0) {
                    ...
                    Toast.makeText(context, context.getString(R.string.toast_product_out_stock),
